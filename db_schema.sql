...
INSERT INTO courses (creator_id, name, description, price, enrollCount, video_url, picture) VALUES (2, 'HTML', 'Master the basics of web development with HTML.', 40.50, 10, 'https://www.youtube.com/watch?v=qz0aGYrrlhU', 'HTML.png');
...
INSERT INTO courses (creator_id, name, description, price, enrollCount, video_url, picture) VALUES (2, 'PHP', 'Develop server-side applications with PHP.', 60.50, 10, 'https://www.youtube.com/watch?v=KBT2gmAfav4', 'PHP.jpg'); 
INSERT INTO courses (creator_id, name, description, price, enrollCount, video_url, picture) VALUES (2, 'Python', 'Explore Python for web development, data science, and more.', 90.50, 750, 'https://www.youtube.com/watch?v=kqtD5dpn9C8', 'Python.png'); 
INSERT INTO courses (creator_id, name, description, price, enrollCount, video_url, picture) VALUES (2, 'C++', 'Enhance your programming skills with C++.', 80.50, 120, 'https://www.youtube.com/watch?v=ZzaPdXTrSb8', 'C++.jpg'); 
INSERT INTO courses (creator_id, name, description, price, enrollCount, video_url, picture) VALUES (2, 'C Sharp', 'Build robust applications using C# and .NET framework.', 50.50, 70, 'https://www.youtube.com/watch?v=gfkTfcpWqAY', 'C Sharp.png'); 
...
INSERT INTO courses (creator_id, name, description, price, enrollCount, video_url, picture) VALUES (2, 'Swift', 'Create iOS apps using Swift.', 90.50, 730, 'https://www.youtube.com/watch?v=comQ1-x2a1Q', 'Swift.jpg'); 
